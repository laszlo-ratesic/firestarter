  ...
  return (
    <div className="navbar bg-base-100">
      ...
      <div className="flex-1">
        <a className="btn btn-ghost normal-case text-2xl">FIRESTARTER</a>
      </div>
      <div className="flex-none">
        <label className="swap swap-rotate" data-toggle-theme="cyberpunk,synthwave" data-act-class="ACTIVECLASS">
          <input type="checkbox" />
